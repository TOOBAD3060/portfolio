...
import Logo from "../assets/toobad_logo.jpg" 
        ...
        <div  className='hidden lg:flex fixed flex-col top-[35%] left-0 '>
            <ul>
                <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600 '>
                    <a rel='noreferrer' target='_blank' href='www.linkedin.com/in/babatunde-olalere-820897240' className='flex justify-between items-center w-full text-gray-300'>
                ...
                <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#6fc2b0] '>
                    <a rel='noreferrer' target='_blank' href='mailto:olalerebabatunde2000@gmail.com' className='flex justify-between items-center w-full text-gray-300' >
